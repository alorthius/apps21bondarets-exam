...
public class JSONApp {
    ...
    public static JsonObject sessionResult() {
        JsonObject oopExam = new JsonObject(new JsonPair("course", new JsonString("OOP")),
                new JsonPair("mark", new JsonNumber(3)),
                new JsonPair("passed", new JsonBoolean(true)));

        JsonObject engExam = new JsonObject(new JsonPair("course", new JsonString("English")),
                new JsonPair("mark", new JsonNumber(5)),
                new JsonPair("passed", new JsonBoolean(true)));

        JsonObject mathExam = new JsonObject(new JsonPair("course", new JsonString("Math")),
        ...
        JsonPair exams = new JsonPair("exams", new JsonArray(oopExam, engExam, mathExam));
